...
public partial class AdventureWorksContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Document>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DocumentLevel, e.DocumentNode }, "AK_Document_DocumentLevel_DocumentNode").IsUnique();

            entity.HasIndex(e => e.Rowguid, "AK_Document_rowguid").IsUnique();

            entity.HasIndex(e => new { e.FileName, e.Revision }, "IX_Document_FileName_Revision");

            entity.HasIndex(e => e.Rowguid, "UQ__Document__F73921F7C81C642F").IsUnique();
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.OrganizationLevel, e.OrganizationNode }, "IX_Employee_OrganizationLevel_OrganizationNode");

            entity.HasIndex(e => e.OrganizationNode, "IX_Employee_OrganizationNode");
            ...
            entity.Property(e => e.OrganizationNode).HasComment("Where the employee is located in corporate hierarchy.");
            entity.Property(e => e.Rowguid)
                .HasDefaultValueSql("(newid())")
                .HasComment("ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample.")
                .HasColumnName("rowguid");
